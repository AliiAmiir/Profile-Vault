...
export default function RegisterationForm({ firstName, lastName, email, phone, gender, dateOfBirth, password, confirmPassword, hobbies, movieGenres, favors, degrees, errors, handleChange, onFormSubmit }) {
  return (
    <View>
      <View style={containerStyles.rowContainer}>
        ...
        <View>
          ...
          <FormInputText label="Date of Birth" placeholder="MM/DD/YYYY" value={dateOfBirth} onChangeText={(value) => handleChange('dateOfBirth', value)} keyboardType="numbers-and-punctuation" errorText={errors.dateOfBirth || null} />
